...
*************************/
    POTENZA.mediav = function () {
        if ($(".audio-video").exists()) {
            loadScript(
                plugin_path +
                    "mediaelement-and-player/mediaelement-and-player.js",
                function () {
...
*************************/
    POTENZA.countdownTimer = function () {
        if ($countdownTimer.exists()) {
            loadScript(
                plugin_path + "countdown/jquery.downCount.js",
                function () {
...
*********************************/
    POTENZA.mobileslider = function () {
        ...
        if (mobileslider.length > 0) {
            loadScript(
                plugin_path + "mobile-slider/zenith.min.js",
                function () {
                    ...
                    function init(id, clr) {
                        var mapOptions = {
                            ...
                            center: new google.maps.LatLng(
                                -37.817078,
                                144.955936
                            ), //Update Latitude and Longitude here
                            styles: clr,
                        };
...
*************************/
    POTENZA.calendarlist = function () {
        if ($("#calendar").exists()) {
            loadScript(
                plugin_path + "fullcalendar/fullcalendar.min.js",
                function () {
...
*************************/
    POTENZA.instagramfeed = function () {
        if ($(".userFeed").exists()) {
            loadScript(
                plugin_path + "instagram/spectragram.min.js",
                function () {
