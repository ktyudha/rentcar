...
@section('content')
    ...
    <div class="mt-16 w-full border bg-white rounded-lg shadow-lg dark:bg-gray-800 p-4 md:p-6">
        <div class="flex justify-between">
            <div>
                <h5 class="leading-none text-xl md:text-3xl font-medium text-[#14477A] pb-2">Statistik
                    Laporan Per Bulan</h5>
            </div>
        </div>
...
@section('additional-scripts')
    ...
    <script>
        ...
        if (document.getElementById("labels-chart") && typeof ApexCharts !== 'undefined') {
            const chart = new ApexCharts(document.getElementById("labels-chart"), chartOptions);
            chart.render();
        }
    </script>
@endsection
