...
<script src="{{ asset('static/admin/js/stisla.js') }}"></script>
...
{{--  <script src="{{ asset('static/admin/js/website.js') }}"></script>
...
{{-- <script src="{{ asset('static/admin/js/page/index-0.js') }}"></script> --}}
